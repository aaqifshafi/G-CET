  ...
  return (
    <article className="overflow-hidden sm:text-lg">
      ...
      <p className="text-lg mt-4">
        <span className="text-4xl text-primary-regular font-bold">G</span>
        overnment College of Engineering & Technology offer a range of
        undergraduate engineering courses designed to equip students with the
        skills and knowledge necessary for success in various industries. Our UG
        programs include:
      </p>
