...
export const metadata = {
  ...
  description:
    "The Department of Civil Engineering at Government College of Engineering & Technology, Safapora offers a range of undergraduate programs designed to equip students with the skills and knowledge necessary for success in the field of civil engineering.",
};
  ...
  return (
    <div className="m-4">
      <article className="overflow-hidden sm:text-lg m-2">
        ...
        <p className="my-8">
          Our mission is to provide a holistic education in civil engineering,
          grounded in principles of innovation, sustainability, and societal
          impact. Through a blend of rigorous academics, hands-on learning
          experiences, and industry partnerships, we strive to cultivate
          well-rounded engineers who are prepared to address the pressing needs
          of our communities and contribute to the advancement of the field.
        </p>
        {/* ===== Faculty Table ===== */}
        ...
        <div className="mb-10">
          ...
          <p className="my-4">
            ...
            critically, solve problems creatively, and pursue excellence in
